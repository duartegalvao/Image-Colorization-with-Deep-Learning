...
class Model:
    ...
    def train(self, X_train, Y_train, labels_train, X_val, Y_val, labels_val):
        ...
        try:
            for epoch in range(self.num_epochs):
                ...
                epoch_classifier_real_loss = 0.0
                epoch_classifier_fake_loss = 0.0
                ...
                for b in range(num_batches):
                    ...
                    epoch_classifier_real_loss += l_class_real / num_batches
                    epoch_classifier_fake_loss += l_class_fake / num_batches
                    epoch_classifier_loss += l_class / num_batches
                ...
                if self.log:
                    ...
                    summary.value.add(tag='classifier_loss', simple_value=epoch_classifier_loss)
                    summary.value.add(tag='classifier_fake_loss', simple_value=epoch_classifier_fake_loss)
                    summary.value.add(tag='classifier_real_loss', simple_value=epoch_classifier_real_loss)
